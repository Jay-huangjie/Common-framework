...
[引导页](https://github.com/TakuSemba/Spotlight)

[跑马灯](https://github.com/sunfusheng/MarqueeView)

[应用角标，icon消息数](https://github.com/leolin310148/ShortcutBadger)

[popWindow封装](https://github.com/razerdp/BasePopup)
...
# 数据库
[GreenDao自动更新库](https://github.com/yuweiguocn/GreenDaoUpgradeHelper)

# 图片
[glide变幻库transformations](https://github.com/wasabeef/glide-transformations)

[图片放大预览，有动画效果](https://github.com/yangchaojiang/ZoomPreviewPicture)
...
# 依赖注入
[koin kotlinDSL实现的依赖注入框架](https://github.com/InsertKoinIO/koin)
...
# 调试
[Log日志打印，只需要一个注解](https://github.com/JakeWharton/hugo)
